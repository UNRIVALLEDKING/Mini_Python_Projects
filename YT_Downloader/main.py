...
SAVE_PATH = "C:/Users/{user}/Downloads/pytube"
...
input_video = ffmpeg.input('C:/Users/{user}/Downloads/pytube/input_video.webm')

input_audio = ffmpeg.input('C:/Users/{user}/Downloads/pytube/input_audio.webm')

ffmpeg.concat(input_video, input_audio, v=1,
              a=1).output('C:/Users/{user}/Downloads/pytube/' + title + ".mkv").run()
